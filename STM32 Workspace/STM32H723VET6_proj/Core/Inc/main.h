...
#define DIR__GPIO_Port GPIOB
#define LAUNCHER_Pin GPIO_PIN_10
#define LAUNCHER_GPIO_Port GPIOB
...
#define DIR_B5_Pin GPIO_PIN_5
#define DIR_B5_GPIO_Port GPIOB
#define GROUND_Pin GPIO_PIN_9
#define GROUND_GPIO_Port GPIOB
